...
Student Intervention System is a project leveraging data about each student to predict which students are likely to drop of and thus require intervention. It makes predictions using 3 supervised learning models including SVM, Naive Bayes and AdaBoosting and compares outcomes in terms of accuracy, time efficiency and training set size needed to predict accurately. Conclusions are made on the best model for the problem and its performance. Project was a part of Udacity Machine Learning Nanodegree.
### Install
